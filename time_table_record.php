            ...
            <div class="card-body">
                <div id="filter-table">
                    <div class="row d-flex" id="custom-filter">
                        ...
                        <div class="form-group col-md-4">
                            <label for="search_exam_id" class=" col-form-label">Exam</label>
                            <select class="form-control select2 select2-hidden-accessible" onchange="listDataTable()" id="exam_id" name="search_exam_id" style="width: 100%;" data-select2-id="search_exam_id" tabindex="-1" aria-hidden="true">
                            <option value=''>Please select Exam</option>
                            </select>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="search_year_id" class=" col-form-label">Exam year</label>
                            <select class="form-control select2 select2-hidden-accessible"  id="year_id" name="search_year_id" style="width: 100%;" data-select2-id="search_year_id" tabindex="-1" aria-hidden="true">
                                <option value="1"></option>
                                <option value="2" selected="" data-select2-id="6">2023-2024</option>
                            </select>
                        </div>
...
<script>
    ...
    $.ajax({
        url: "time_table/time_table_exams.php",
        type: "POST",
        data: {
